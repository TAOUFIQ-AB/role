    ...
    def _run_hunt(self) -> None:
        ...
        try:
            ...
            while not self.wq.scan.empty():
                ...
                # Process the first attempt directly. Do not also enqueue it in
                # the process queue, otherwise every task is left behind and can
                # be processed a second time when retries are flushed.
